# modified from buildroot/package/pkg-kconfig.mk
...
$(2)_KCONFIG_MAKE = \
	cd $$($(2)_PKGDIR) && $$($(2)_MAKE_ENV) $$(MAKE) $$($(2)_KCONFIG_OPTS)
...
ifneq ($$($(2)_KCONFIG_FILE),)
$(2)_KCONFIG_DEFCONFIG ?= $$(notdir $$($(2)_KCONFIG_FILE))
endif
...
# full .config first.
$$($(2)_PKGDIR)/$$($(2)_KCONFIG_DOTCONFIG): $$($(2)_KCONFIG_FILE) $$($(2)_KCONFIG_FRAGMENT_FILES)
	$$(Q)$$(if $$($(2)_KCONFIG_DEFCONFIG), \
		$$($(2)_KCONFIG_MAKE) $$($(2)_KCONFIG_DEFCONFIG), \
		$$(INSTALL) -m 0644 -D $$($(2)_KCONFIG_FILE) $$(@))
	$$(Q)$(BR_TOP_DIR)/support/kconfig/merge_config.sh -m -O $$(@D) \
		$$(@) $$($(2)_KCONFIG_FRAGMENT_FILES)
#	$$($(2)_REGEN_DOT_CONFIG)
...
$$($(2)_DIR)/.stamp_kconfig_fixup_done: $$($(2)_PKGDIR)/$$($(2)_KCONFIG_DOTCONFIG)
	$(Q)mkdir -p $$(@D)
	$$($(2)_FIXUP_DOT_CONFIG)
...
# kconfig is special, kconfig_fixup_done before target_configure
ifneq ($$($(2)_CONFIGURE_DEP_CONFIGS),)
$$($(2)_DIR)/.stamp_kconfig_fixup_done:	$$(call trans_macros_to_depfile,$$($(2)_CONFIGURE_DEP_CONFIGS),$(HOST_CONFIG_DIR)/)
endif
$$($(2)_DIR)/.stamp_kconfig_fixup_done: $(rvmk_file)

ifneq ($$($(2)_CONFIGURE_DEP_FILES),)
$$($(2)_DIR)/.stamp_kconfig_fixup_done: $$($(2)_CONFIGURE_DEP_FILES)
endif
...
$$($(2)_DIR)/.kconfig_editor_%: $$($(2)_DIR)/.stamp_kconfig_fixup_done
	$$($(2)_CONFIGURATOR_MAKE_ENV) $$(MAKE) -C $$($(2)_PKGDIR) \
		$$($(2)_KCONFIG_OPTS) $$(*)
...
$(1)-update-config: $(1)-check-configuration-done
	...
	cp -f $$($(2)_PKGDIR)/$$($(2)_KCONFIG_DOTCONFIG) $$($(2)_KCONFIG_FILE)
	touch --reference $$($(2)_PKGDIR)/$$($(2)_KCONFIG_DOTCONFIG) $$($(2)_KCONFIG_FILE)
...
$(1)-update-defconfig: $(1)-savedefconfig
	...
	cp -f $$($(2)_PKGDIR)/defconfig $$($(2)_KCONFIG_FILE)
	touch --reference $$($(2)_PKGDIR)/$$($(2)_KCONFIG_DOTCONFIG) $$($(2)_KCONFIG_FILE)
